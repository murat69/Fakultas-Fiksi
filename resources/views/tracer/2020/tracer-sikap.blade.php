        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top: 50px">
                    Mayoritas responden dari kuesioner pengguna lulusan mengatakan bahwa lulusan memiliki integritas
                    (Etikadan moral) yang sangat baik (12responden atau 85,71%).
                </div>
            </div>
        </div>
        <section id="monev">
