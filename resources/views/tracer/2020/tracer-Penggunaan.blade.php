    ...
    <section id="team" class="team">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Penilaian Pengguna Terhadap Kemampuan Penggunaan Teknologi Informasi Lulusan</h2>
            </div>

            <div class="row">
                <div class="col-lg-12" style="margin-top: 50px">
                    Mayoritas responden dari kuesioner pengguna lulusan mengatakan bahwa lulusan memiliki kemampuan
                    penggunaan teknologi informasi dengan sangat baik (10 responden atau 71,43%).
                </div>
            </div>
        </div>
        <section id="monev">
...
@section('script')
    ...
    <script>
        Highcharts.chart('usia', {
            ...
            title: {
                align: 'left',
                text: 'PENILAIAN PENGGUNA TERHADAP KEMAMPUAN PENGGUNAAN TEKNOLOGI INFORMASI LULUSAN'
            },
            subtitle: {
                align: 'left',
                text: '4 Jawaban'
