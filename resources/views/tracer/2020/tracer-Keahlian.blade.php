        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top: 50px">
                    Mayoritas responden dari kuesioner pengguna lulusan mengatakan bahwa lulusan arsitektur memiliki
                    keahlian berdasarkan bidang ilmu/profesionalisme (10 responden atau 71,43%). Responden memberikan
                    tingkat kepuasan sangat baik pada bidang keahlian lulusan.
                </div>
            </div>
        </div>
        <section id="monev">
