        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row">
                ...
                <div class="img text-center col-lg-5 d-flex flex-column  order-2 order-lg-1"
                    style="background-image: url('{{ asset('storage/upload/file/' . $kap_ars->file->file) }}');"
    ...
    <section id="team" class="team ">
        <div class="container struktur" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 fade-kanan d-flex justify-content-center">
                    <img src="{{ asset('storage/upload/file/' . @$struktur->file->file) }}" alt="" class="imgakre">
                </div>
            </div>
        </div>
    </section>
