    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 entries">
              <h4 class="text-center mb-5">Aspek Formalitas Pekerjaan</h4>
              <div class="col-md-12 mx-auto mb-5">
                <p>Terdapat peraturan dan prosedur yang harus saya penuhi  agar Saya bisa bekerja dengan baik </p>
                <div id="chart1"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Birokrasi menunjang saya untuk melakukan pekerjaan yang baik </p>
                <div id="chart2"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Saya harus melakukan banyak pekerjaan rutin di kantor </p>
                <div id="chart3"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Terdapat petunjuk untuk menjalankan pekerjaan saya </p>
                <div id="chart4"></div>
              </div>
              <!-- End blog entry -->
          </div>
