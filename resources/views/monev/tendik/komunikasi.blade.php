    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 entries">
              <h4 class="text-center mb-5">Aspek Komunikasi Organisasional</h4>
              <div class="col-md-12 mx-auto mb-5">
                <p>Terdapat komunikasi yang baik antar rekan kerja dalam lingkungan kerja. Terdapat tujuan yang jelas dalam unit kerja  </p>
                <div id="chart1"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Saya memiliki kesadaran bahwa pekerjaan yang saya lakukan harus selesai tepat waktu </p>
                <div id="chart2"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Saya menerima penjelasan yang memadai selama menjalankan tugas </p>
                <div id="chart3"></div>
              </div>
              <div class="col-md-12 mx-auto mb-5">
                <p>Terdapat komunikasi yang baik antar rekan kerja dalam lingkungan kerja. Terdapat tujuan yang jelas dalam unit kerja</p>
